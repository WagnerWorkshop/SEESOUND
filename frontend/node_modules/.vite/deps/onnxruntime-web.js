...
var qa = V(() => {
  ...
  }, Fa = (t, e, r) => new De({ location: "cpu-pinned", type: t, data: e, dims: r ?? [e.length] });
});
var Pt;
var Jt;
var Ka;
...
var ls = V(() => {
  ...
  vt();
  Ar();
  ss = "ort-wasm-proxy-worker", us = ((_a = globalThis.self) == null ? void 0 : _a.name) === ss;
  us && (self.onmessage = (t) => {
...
async function cs(t = {}) {
  ...
  let i = (a) => async (...l) => {
    ...
    try {
      ...
      (_a3 = e.dd) == null ? void 0 : _a3.flush();
      let w = h.errors;
      if (0 < w.length) {
...
`));
  ...
  e.jsepInit = (a, l) => {
    if (a === "webgpu") {
      ...
      let h = l[0];
      [e.Sd, e.sd, e.webnnEnsureTensor, e.td, e.webnnDownloadTensor, e.Rd, e.webnnEnableTraceEvent] = l.slice(1), e.webnnReleaseTensorId = e.sd, e.webnnUploadTensor = e.td, e.webnnRegisterMLContext = e.Rd, e.webnnOnRunStart = (f) => h.onRunStart(f), e.webnnOnRunEnd = h.onRunEnd.bind(h), e.webnnOnReleaseSession = (f) => {
        h.onReleaseSession(f);
  ...
  function Me() {
    var a = ht.buffer;
    e.HEAP8 = N = new Int8Array(a), q = new Int16Array(a), e.HEAPU8 = F = new Uint8Array(a), X = new Uint16Array(a), e.HEAP32 = B = new Int32Array(a), e.HEAPU32 = L = new Uint32Array(a), Q = new Float32Array(a), Y = new Float64Array(a), Z = new BigInt64Array(a), te = new BigUint64Array(a);
  }
  function ve() {
    le = true, o ? x() : ct.sb();
  }
  function M(a) {
    throw E(a = "Aborted(" + a + ")"), A = true, a = new WebAssembly.RuntimeError(a + ". Build with -sASSERTIONS for more info."), T == null ? void 0 : T(a), a;
  }
  function G() {
  ...
  async function be() {
    function a(f, w) {
      var C = ct = f.exports;
      f = {};
      for (let [P, D] of Object.entries(C)) typeof D == "function" ? (C = Np(D), f[P] = C) : f[P] = D;
  ...
  var $e = (a) => {
    ...
    var f, w = 16 * h.length, C = de(), P = Mn(w), D = P >>> 3;
    for (f of h) typeof f == "bigint" ? ((v(), Z)[D++ >>> 0] = 1n, (v(), Z)[D++ >>> 0] = f) : ((v(), Z)[D++ >>> 0] = 0n, (v(), Y)[D++ >>> 0] = f);
  ...
  function lt(a, l, h = {}) {
    return function(f, w, C = {}) {
      ...
      xn[f] = w, delete fp[f], $n.hasOwnProperty(f) && (w = $n[f], delete $n[f], w.forEach((D) => D()));
    }(a, l, h);
  }
  var pi = (a, l, h) => {
    switch (l) {
      ...
      case 4:
        return h ? (f) => (v(), B)[f >>> 2 >>> 0] : (f) => (v(), L)[f >>> 2 >>> 0];
      case 8:
  ...
  function hp(a, l, h, f, w) {
    ...
    lt(a, { name: l, Oc: C, Vc: (P, D) => (typeof D == "number" && (D = BigInt(D)), D), Uc: pi(l, h, !f), Wc: null });
  }
  function gp(a, l, h, f) {
  ...
  function vp(a, l, h, f, w) {
    ...
    lt(a, { name: l, Oc: C, Vc: (D, H) => H, Uc: pi(l, h, f !== 0), Wc: null });
  }
  function $p(a, l, h) {
    function f(C) {
      var P = (v(), L)[C >>> 2 >>> 0];
  ...
  function xp(a, l) {
    lt(a >>>= 0, { name: l = Je(l >>> 0), Oc(h) {
      ...
      var C = w ? mr(f) : f.length, P = Qt(4 + C + 1), D = P + 4;
      return (v(), L)[P >>> 2 >>> 0] = C, w ? gt(f, D, C + 1) : (v(), F).set(f, D >>> 0), h !== null && h.push(tt, P), P;
    }, Uc: Tn, Wc(h) {
      tt(h);
    } });
  }
  ...
  function kp(a, l, h) {
    ...
    lt(a, { name: h, Oc: (P) => {
      var D = (v(), L)[P >>> 2 >>> 0];
      return D = f(P + 4, D * l, true), tt(P), D;
    }, Vc: (P, D) => {
  ...
  }, zp = !Atomics.waitAsync || ((_b2 = globalThis.navigator) == null ? void 0 : _b2.userAgent) && 91 > Number((navigator.userAgent.match(/Chrom(e|ium)\/([0-9]+)\./) || [])[2]);
  function In(a) {
  ...
  var kn = [], Gp = (a) => {
    ...
    for (var h = Array(a), f = 0; f < a; ++f) {
      ...
      if (P === void 0) throw a = `parameter ${f}`, C = Di(C), l = Je(C), tt(C), new Nt(`${a} has unknown type ${l}`);
      h[w] = P;
    }
    return h;
  }, Fp = (a, l, h) => {
  ...
  function Kp(a, l, h) {
    ...
    return D += `(${a})`, f.zd || (P.toReturnWire = l, P.emval_returnValue = Fp, D = `return emval_returnValue(toReturnWire, destructorsRef, ${D})`), D = `return function (handle, methodName, destructorsRef, args) {
  ${D}
  }`, h = new Function(Object.keys(P), D)(...Object.values(P)), D = `methodCaller<(${w.map((H) => H.name)}) => ${f.name}>`, Gp(Object.defineProperty(h, "name", { value: D }));
  }
  function jp(a, l) {
  ...
  function sm(a, l) {
    ...
    a = 0 | (h != f && a.getTimezoneOffset() == Math.min(f, h)), (v(), B)[l + 32 >>> 2 >>> 0] = a;
  }
  function um(a) {
    a >>>= 0;
    var l = new Date((v(), B)[a + 20 >>> 2 >>> 0] + 1900, (v(), B)[a + 16 >>> 2 >>> 0], (v(), B)[a + 12 >>> 2 >>> 0], (v(), B)[a + 8 >>> 2 >>> 0], (v(), B)[a + 4 >>> 2 >>> 0], (v(), B)[a >>> 2 >>> 0], 0), h = (v(), B)[a + 32 >>> 2 >>> 0], f = l.getTimezoneOffset(), w = new Date(l.getFullYear(), 6, 1).getTimezoneOffset(), C = new Date(l.getFullYear(), 0, 1).getTimezoneOffset(), P = Math.min(C, w);
    return 0 > h ? (v(), B)[a + 32 >>> 2 >>> 0] = +(w != C && P == f) : 0 < h != (P == f) && (w = Math.max(C, w), l.setTime(l.getTime() + 6e4 * ((0 < h ? P : w) - f))), (v(), B)[a + 24 >>> 2 >>> 0] = l.getDay(), h = (wi(l.getFullYear()) ? vi : $i)[l.getMonth()] + l.getDate() - 1 | 0, (v(), B)[a + 28 >>> 2 >>> 0] = h, (v(), B)[a >>> 2 >>> 0] = l.getSeconds(), (v(), B)[a + 4 >>> 2 >>> 0] = l.getMinutes(), (v(), B)[a + 8 >>> 2 >>> 0] = l.getHours(), (v(), B)[a + 12 >>> 2 >>> 0] = l.getDate(), (v(), B)[a + 16 >>> 2 >>> 0] = l.getMonth(), (v(), B)[a + 20 >>> 2 >>> 0] = l.getYear(), a = l.getTime(), BigInt(isNaN(a) ? -1 : a / 1e3);
  }
  ...
  var Pn = [], Ii = (a, l) => {
    ...
    for (var h; h = (v(), F)[a++ >>> 0]; ) {
      var f = h != 105;
      l += (f &= h != 112) && l % 8 ? 4 : 0, Pn.push(h == 112 ? (v(), L)[l >>> 2 >>> 0] : h == 106 ? (v(), Z)[l >>> 3 >>> 0] : h == 105 ? (v(), B)[l >>> 2 >>> 0] : (v(), Y)[l >>> 3 >>> 0]), l += f ? 8 : 4;
    }
    return Pn;
  };
  function fm(a, l, h) {
...
`))[0] == "Error" && f.shift(), Ci(f);
    ...
    for (a = 0; a < h && f[a + w]; ++a) (v(), B)[l + 4 * a >>> 2 >>> 0] = _r(f[a + w]);
    return a;
  }
  var On, zn = {}, Ai = () => {
    var _a3;
  ...
  var Di, Mi, vr, tt, Qt, Bn, Ri, Ui, Ni, Dn, Vi, Li, ce, Yt, Wi, ue, Mn, de, Gi, Rn, Hi, Fi, qi, Un, Ki, ji, Zi, Qi, Yi, Xi, Ji, ea, ta, ra, na, oa, ia, aa, sa, ua, da, la, ca, pa, ma, fa, ha, ga, ba, ya, _a, wa, va, $a, xa, Sa, Ta, Ia, Ca, Aa, Ea, ka, Pa, ct, Im = [lr, Vo, jo, Jo, ei, ti, ri, ni, oi, ii, ai, si, ui, di, li, ci, xi, Si, Ti, Ei, ki, Pi, Oi, zi, Bi], Nn = { 1003524: (a, l, h, f, w) => {
    ...
    e.Gd();
  }, 1004576: (a) => e.Ad(a), 1004609: (a) => e.Ed(a), 1004641: (a, l, h) => {
    ...
    e.$b("ReduceMean", a, { keepDims: !!l, noopWithEmptyAxes: !!h, axes: f ? Array.from((v(), B).subarray(Number(f) >>> 0, Number(w) >>> 0)) : [] });
  }, 1007283: (a, l, h, f, w) => {
    e.$b("ReduceMax", a, { keepDims: !!l, noopWithEmptyAxes: !!h, axes: f ? Array.from((v(), B).subarray(Number(f) >>> 0, Number(w) >>> 0)) : [] });
  }, 1007457: (a, l, h, f, w) => {
    e.$b("ReduceMin", a, { keepDims: !!l, noopWithEmptyAxes: !!h, axes: f ? Array.from((v(), B).subarray(Number(f) >>> 0, Number(w) >>> 0)) : [] });
  }, 1007631: (a, l, h, f, w) => {
    e.$b("ReduceProd", a, { keepDims: !!l, noopWithEmptyAxes: !!h, axes: f ? Array.from((v(), B).subarray(Number(f) >>> 0, Number(w) >>> 0)) : [] });
  }, 1007806: (a, l, h, f, w) => {
    e.$b("ReduceSum", a, { keepDims: !!l, noopWithEmptyAxes: !!h, axes: f ? Array.from((v(), B).subarray(Number(f) >>> 0, Number(w) >>> 0)) : [] });
  }, 1007980: (a, l, h, f, w) => {
    e.$b("ReduceL1", a, { keepDims: !!l, noopWithEmptyAxes: !!h, axes: f ? Array.from((v(), B).subarray(Number(f) >>> 0, Number(w) >>> 0)) : [] });
  }, 1008153: (a, l, h, f, w) => {
    e.$b("ReduceL2", a, { keepDims: !!l, noopWithEmptyAxes: !!h, axes: f ? Array.from((v(), B).subarray(Number(f) >>> 0, Number(w) >>> 0)) : [] });
  }, 1008326: (a, l, h, f, w) => {
    e.$b("ReduceLogSum", a, { keepDims: !!l, noopWithEmptyAxes: !!h, axes: f ? Array.from((v(), B).subarray(Number(f) >>> 0, Number(w) >>> 0)) : [] });
  }, 1008503: (a, l, h, f, w) => {
    e.$b("ReduceSumSquare", a, { keepDims: !!l, noopWithEmptyAxes: !!h, axes: f ? Array.from((v(), B).subarray(Number(f) >>> 0, Number(w) >>> 0)) : [] });
  }, 1008683: (a, l, h, f, w) => {
    e.$b("ReduceLogSumExp", a, { keepDims: !!l, noopWithEmptyAxes: !!h, axes: f ? Array.from((v(), B).subarray(Number(f) >>> 0, Number(w) >>> 0)) : [] });
  }, 1008863: (a) => {
    e.$b("Where", a, void 0);
  }, 1008916: (a, l, h) => {
    e.$b("Transpose", a, { perm: l ? Array.from((v(), B).subarray(Number(l) >>> 0, Number(h) >>> 0)) : [] });
  }, 1009040: (a, l, h, f) => {
    e.$b("DepthToSpace", a, { blocksize: l, mode: Ae(h), format: f ? "NHWC" : "NCHW" });
  }, 1009173: (a, l, h, f) => {
    e.$b("DepthToSpace", a, { blocksize: l, mode: Ae(h), format: f ? "NHWC" : "NCHW" });
  }, 1009306: (a, l, h, f, w, C, P, D, H, K, se, pe, xe, Ie, yt) => {
    e.$b("ConvTranspose", a, { format: H ? "NHWC" : "NCHW", autoPad: l, dilations: [h], group: f, kernelShape: [w], pads: [C, P], strides: [D], wIsConst: () => !!(v(), N)[K >>> 0], outputPadding: se ? Array.from((v(), B).subarray(Number(se) >>> 0, Number(pe) >>> 0)) : [], outputShape: xe ? Array.from((v(), B).subarray(Number(xe) >>> 0, Number(Ie) >>> 0)) : [], activation: Ae(yt) });
  }, 1009739: (a, l, h, f, w, C, P, D, H, K, se, pe, xe, Ie) => {
  ...
  }, 1010400: (a, l, h, f, w, C, P, D, H, K, se, pe, xe, Ie, yt) => {
    e.$b("ConvTranspose", a, { format: H ? "NHWC" : "NCHW", autoPad: l, dilations: [h], group: f, kernelShape: [w], pads: [C, P], strides: [D], wIsConst: () => !!(v(), N)[K >>> 0], outputPadding: se ? Array.from((v(), B).subarray(Number(se) >>> 0, Number(pe) >>> 0)) : [], outputShape: xe ? Array.from((v(), B).subarray(Number(xe) >>> 0, Number(Ie) >>> 0)) : [], activation: Ae(yt) });
  }, 1010833: (a, l, h, f, w, C, P, D, H, K, se, pe, xe, Ie) => {
    e.$b("ConvTranspose", a, { format: D ? "NHWC" : "NCHW", autoPad: l, dilations: Array.from((v(), B).subarray(Number(h) >>> 0, (Number(h) >>> 0) + 2 >>> 0)), group: f, kernelShape: Array.from((v(), B).subarray(Number(w) >>> 0, (Number(w) >>> 0) + 2 >>> 0)), pads: Array.from((v(), B).subarray(Number(C) >>> 0, (Number(C) >>> 0) + 4 >>> 0)), strides: Array.from((v(), B).subarray(Number(P) >>> 0, (Number(P) >>> 0) + 2 >>> 0)), wIsConst: () => !!(v(), N)[H >>> 0], outputPadding: K ? Array.from((v(), B).subarray(Number(K) >>> 0, Number(se) >>> 0)) : [], outputShape: pe ? Array.from((v(), B).subarray(Number(pe) >>> 0, Number(xe) >>> 0)) : [], activation: Ae(Ie) });
  }, 1011494: (a, l) => {
    e.$b("GlobalAveragePool", a, { format: l ? "NHWC" : "NCHW" });
  }, 1011585: (a, l, h, f, w, C, P, D, H, K, se, pe, xe, Ie) => {
    ...
    e.$b("GlobalAveragePool", a, { format: l ? "NHWC" : "NCHW" });
  }, 1012155: (a, l, h, f, w, C, P, D, H, K, se, pe, xe, Ie) => {
    e.$b("AveragePool", a, { format: Ie ? "NHWC" : "NCHW", auto_pad: l, ceil_mode: h, count_include_pad: f, storage_order: w, dilations: C ? Array.from((v(), B).subarray(Number(C) >>> 0, Number(P) >>> 0)) : [], kernel_shape: D ? Array.from((v(), B).subarray(Number(D) >>> 0, Number(H) >>> 0)) : [], pads: K ? Array.from((v(), B).subarray(Number(K) >>> 0, Number(se) >>> 0)) : [], strides: pe ? Array.from((v(), B).subarray(Number(pe) >>> 0, Number(xe) >>> 0)) : [] });
  }, 1012634: (a, l) => {
    e.$b("GlobalMaxPool", a, { format: l ? "NHWC" : "NCHW" });
  }, 1012721: (a, l, h, f, w, C, P, D, H, K, se, pe, xe, Ie) => {
    e.$b("MaxPool", a, { format: Ie ? "NHWC" : "NCHW", auto_pad: l, ceil_mode: h, count_include_pad: f, storage_order: w, dilations: C ? Array.from((v(), B).subarray(Number(C) >>> 0, Number(P) >>> 0)) : [], kernel_shape: D ? Array.from((v(), B).subarray(Number(D) >>> 0, Number(H) >>> 0)) : [], pads: K ? Array.from((v(), B).subarray(Number(K) >>> 0, Number(se) >>> 0)) : [], strides: pe ? Array.from((v(), B).subarray(Number(pe) >>> 0, Number(xe) >>> 0)) : [] });
  }, 1013196: (a, l) => {
    e.$b("GlobalMaxPool", a, { format: l ? "NHWC" : "NCHW" });
  }, 1013283: (a, l, h, f, w, C, P, D, H, K, se, pe, xe, Ie) => {
    e.$b("MaxPool", a, { format: Ie ? "NHWC" : "NCHW", auto_pad: l, ceil_mode: h, count_include_pad: f, storage_order: w, dilations: C ? Array.from((v(), B).subarray(Number(C) >>> 0, Number(P) >>> 0)) : [], kernel_shape: D ? Array.from((v(), B).subarray(Number(D) >>> 0, Number(H) >>> 0)) : [], pads: K ? Array.from((v(), B).subarray(Number(K) >>> 0, Number(se) >>> 0)) : [], strides: pe ? Array.from((v(), B).subarray(Number(pe) >>> 0, Number(xe) >>> 0)) : [] });
  }, 1013758: (a, l, h, f, w) => {
    ...
    e.$b("Split", a, { axis: l, numOutputs: h, splitSizes: f ? Array.from((v(), B).subarray(Number(f) >>> 0, Number(w) >>> 0)) : [] });
  }, 1014411: (a) => {
    e.$b("Expand", a, void 0);
  }, 1014465: (a, l) => {
  ...
  }, 1014694: (a, l, h, f, w, C, P, D, H, K, se) => {
    e.$b("Resize", a, { antialias: l, axes: h ? Array.from((v(), B).subarray(Number(h) >>> 0, Number(f) >>> 0)) : [], coordinateTransformMode: Ae(w), cubicCoeffA: C, excludeOutside: P, extrapolationValue: D, keepAspectRatioPolicy: Ae(H), mode: Ae(K), nearestMode: Ae(se) });
  }, 1015056: (a, l, h, f, w, C, P) => {
    e.$b("Slice", a, { starts: l ? Array.from((v(), B).subarray(Number(l) >>> 0, Number(h) >>> 0)) : [], ends: f ? Array.from((v(), B).subarray(Number(f) >>> 0, Number(w) >>> 0)) : [], axes: C ? Array.from((v(), B).subarray(Number(C) >>> 0, Number(P) >>> 0)) : [] });
  }, 1015320: (a) => {
    e.$b("Tile", a, void 0);
  }, 1015372: (a, l, h) => {
    ...
    e.$b("Pad", a, { mode: l, value: h, pads: f ? Array.from((v(), B).subarray(Number(f) >>> 0, Number(w) >>> 0)) : [] });
  }, 1015877: (a, l, h, f, w, C) => {
  ...
  }, 1016827: (a, l, h, f, w, C, P, D, H) => {
    e.$b("Attention", a, { numHeads: l, isUnidirectional: h, maskFilterValue: f, scale: w, doRotary: C, qkvHiddenSizes: P ? Array.from((v(), B).subarray(Number(D) >>> 0, Number(D) + P >>> 0)) : [], pastPresentShareBuffer: !!H });
  }, 1017099: (a) => {
  ...
  }, 1017271: (a, l, h, f, w, C, P, D, H, K, se, pe, xe, Ie, yt, Vn) => {
    e.$b("Conv", a, { format: pe ? "NHWC" : "NCHW", auto_pad: l, dilations: h ? Array.from((v(), B).subarray(Number(h) >>> 0, Number(f) >>> 0)) : [], group: w, kernel_shape: C ? Array.from((v(), B).subarray(Number(C) >>> 0, Number(P) >>> 0)) : [], pads: D ? Array.from((v(), B).subarray(Number(D) >>> 0, Number(H) >>> 0)) : [], strides: K ? Array.from((v(), B).subarray(Number(K) >>> 0, Number(se) >>> 0)) : [], w_is_const: () => !!(v(), N)[Number(xe) >>> 0], activation: Ae(Ie), activation_params: yt ? Array.from((v(), Q).subarray(Number(yt) >>> 0, Number(Vn) >>> 0)) : [] });
  }, 1017855: (a) => {
    e.$b("Gelu", a, void 0);
  }, 1017907: (a, l, h, f, w, C, P, D, H) => {
    e.$b("GroupQueryAttention", a, { numHeads: l, kvNumHeads: h, scale: f, softcap: w, doRotary: C, rotaryInterleaved: P, smoothSoftmax: D, localWindowSize: H });
  }, 1018124: (a, l, h, f) => {
    ...
    e.Fd(a);
  }, 1019194: (a, l) => e.Hd(Number(a), Number(l), e.Yc.Kd, e.Yc.errors) };
  function Cm(a, l, h) {
    return yi(async () => {
  ...
  function Fm(a, l, h, f, w, C, P, D, H, K, se, pe) {
    var xe = de();
    try {
      ia(a, l, h, f, w, C, P, D, H, K, se, pe);
    } catch (Ie) {
  ...
  function jm(a, l, h, f, w, C, P, D, H) {
    var K = de();
    try {
      Yi(a, l, h, f, w, C, P, D, H);
    } catch (se) {
  ...
  function rf(a, l, h, f, w, C, P, D) {
    var H = de();
    try {
      return sa(a, l, h, f, w, C, P, D);
    } catch (K) {
      if (ue(H), K !== K + 0) throw K;
      ce(1, 0);
    }
  ...
  function sf(a, l, h, f, w, C, P, D, H, K, se, pe) {
    var xe = de();
    try {
      return Ia(a, l, h, f, w, C, P, D, H, K, se, pe);
    } catch (Ie) {
      if (ue(xe), Ie !== Ie + 0) throw Ie;
      ce(1, 0);
    }
  }
  function uf(a, l, h, f, w, C, P, D, H, K, se) {
    var pe = de();
    try {
      ba(a, l, h, f, w, C, P, D, H, K, se);
    } catch (xe) {
      if (ue(pe), xe !== xe + 0) throw xe;
      ce(1, 0);
    }
  }
  function df(a, l, h, f, w, C, P, D, H, K, se, pe, xe, Ie, yt, Vn) {
    var mf = de();
    try {
      ya(a, l, h, f, w, C, P, D, H, K, se, pe, xe, Ie, yt, Vn);
    } catch (Ln) {
  ...
  function $r() {
    if (0 < he) Te = $r;
    else if (o) _ == null ? void 0 : _(e), ve();
    else {
      for (var a = Pe; 0 < a.length; ) a.shift()(e);
      0 < he ? Te = $r : (e.calledRun = true, A || (ve(), _ == null ? void 0 : _(e)));
    }
  }
...
var ms = V(() => {
  "use strict";
  var _a, _b2;
  vf = cs, $f = (_b2 = (_a = globalThis.self) == null ? void 0 : _a.name) == null ? void 0 : _b2.startsWith("em-pthread");
  $f && cs();
});
var gs;
var Xn;
...
var vt = V(() => {
  ...
  eo = false, Rr = false, vs = false, Cf = () => {
    ...
    let o = t.wasmPaths, i = typeof o == "string" ? o : void 0, s = o == null ? void 0 : o.mjs, u = (s == null ? void 0 : s.href) ?? s, d = o == null ? void 0 : o.wasm, c = (d == null ? void 0 : d.href) ?? d, p = t.wasmBinary, [m, g] = await ws(u, i, r > 1, !!p || !!c), y = false, b = [];
...
var xs = V(() => {
  ...
  $s = (t) => {
    ...
    try {
      ...
      let i = 0;
      return (t == null ? void 0 : t.tag) !== void 0 && (i = Ge(t.tag, n)), r = e._OrtCreateRunOptions(o.logSeverityLevel, o.logVerbosityLevel, !!o.terminate, i), r === 0 && me("Can't create run options."), (t == null ? void 0 : t.extra) !== void 0 && tr(t.extra, "", /* @__PURE__ */ new WeakSet(), (s, u) => {
...
var nt = V(() => {
  ...
  J();
  Bf = ["V", "I", "W", "E", "F"], Df = (t, e) => {
    console.log(`[${Bf[t]},${(/* @__PURE__ */ new Date()).toISOString()}]${e}`);
  }, Lr = (t, e) => {
    Is = t, Cs = e;
  }, Mf = (t, e) => {
    let r = rr(t), n = rr(Is);
    r >= n && Df(r, typeof e == "function" ? e() : e);
  }, ie = (...t) => {
    Cs && Mf(...t);
  };
});
  ...
  Ps = /* @__PURE__ */ new Map([["float32", 32], ["float16", 16], ["int32", 32], ["uint32", 32], ["int64", 64], ["uint64", 64], ["int8", 8], ["uint8", 8], ["int4", 4], ["uint4", 4]]), ao = (t, e) => {
    ...
    async ensureTensor(e, r, n, o) {
      ...
      if (!(s == null ? void 0 : s.input.dataTypes.includes(r))) {
        if (u = Uf.get(r), !u || (s == null ? void 0 : s.input.dataTypes.includes(u))) throw new Error(`WebNN backend does not support data type: ${r}`);
    ...
    async download(e) {
      ...
      if (this.activeUpload) {
        let r = ((_a = this.wrapper) == null ? void 0 : _a.isDataConverted) ? Os(this.activeUpload, (_b2 = this.wrapper) == null ? void 0 : _b2.type) : this.activeUpload;
        if (e) {
    ...
    async download(e, r) {
      ie("verbose", () => `[WebNN] TensorManager.download {tensorId: ${e}, dstBuffer: ${r == null ? void 0 : r.byteLength}}`);
      let n = this.tensorTrackersById.get(e);
      if (!n) throw new Error("Tensor not found.");
      return n.download(r);
    }
    ...
    registerMLConstant(e, r, n, o, i, s, u = false) {
      ...
      switch (i.dataType) {
        case "float32":
          ...
          break;
        case "float16":
          m = typeof Float16Array < "u" ? new Float16Array(p) : new Uint16Array(p);
          break;
        case "int32":
          m = new Int32Array(p);
          break;
...
var oe = V(() => {
  ...
  fn get_${t}(${M}) -> ${p} {
    ...
    }, Z = (M) => s < 2 ? B(M) : (b.getByIndices = true, b.indicesToOffset = true, `get_${t}ByIndices(${M})`), te = s < 2 ? "" : `
...
`);
    ...
    }, setByOffset: X, setByIndices: (M, G) => s < 2 ? X(M, G) : (b.setByIndices = true, b.indicesToOffset = true, `set_${t}ByIndices(${M}, ${G});`), get: Y, getByOffset: B, getByIndices: Z, usage: n, name: t, strides: x, shape: T, rank: s };
...
var pt = V(() => {
  ...
  ${_.mainStart()}
    ...
    Wf(t.inputs, e.perm), t.compute(Be(t.inputs[0], e.perm));
  }, qs = (t) => ee({ perm: t.perm });
});
var Kf;
var jf;
...
var nu = V(() => {
  ...
  Kf = { max: "select(bestValue, candidate, candidate > bestValue)", min: "select(bestValue, candidate, candidate < bestValue)", mean: "bestValue + candidate", sum: "bestValue + candidate", prod: "bestValue * candidate", sumSquare: "bestValue + candidate * candidate", logSumExp: "bestValue + exp(candidate)", l1: "bestValue + abs(candidate)", l2: "bestValue + candidate * candidate", logSum: "bestValue + candidate" }, jf = { max: "select(bestValue, candidate, candidate > bestValue)", min: "select(bestValue, candidate, candidate < bestValue)", mean: "bestValue + candidate", sum: "bestValue + candidate", prod: "bestValue * candidate", sumSquare: "bestValue + candidate", logSumExp: "bestValue + candidate", l1: "bestValue + candidate", l2: "bestValue + candidate", logSum: "bestValue + candidate" }, Zf = { max: "_A[offset]", min: "_A[offset]", mean: "0", sum: "0", prod: "1", sumSquare: "0", logSumExp: "0", l1: "0", l2: "0", logSum: "0" }, Qf = { max: "bestValue", min: "bestValue", sum: "bestValue", prod: "bestValue", sumSquare: "bestValue", logSumExp: "log(bestValue)", l1: "bestValue", l2: "sqrt(bestValue)", logSum: "log(bestValue)" }, Yf = (t, e) => {
    ...
    c.length > 0 && (d = t.compute(Be(t.inputs[0], c), { inputs: [0], outputs: [-1] })[0], u = Yf(u.length, d.dims.length));
...
var St = V(() => {
  ...
  Qe = (t, e, r = "f32") => {
    ...
    if (e === "HardSigmoid") {
      ...
      let [r, n] = (t == null ? void 0 : t.activation_params) || [As, Es];
...
`;
    ...
    let q = (X) => {
      let B = p.length, L = Qr("batchDims", t[0].dataType, B, 1), Q = we(t[0].dataType), Y = O("a", t[0].dataType, E, S), Z = O("b", t[1].dataType, z, S), te = U("result", t[0].dataType, v.length, S), ae = [Y, Z];
      if (F) {
        let G = o ? S : 1;
...
var Cd = V(() => {
  ...
  Lh = (t, e, r, n, o = false, i, s = 4, u = 4, d = 4, c = "f32") => {
    ...
    return { name: "Conv2DMatMul", shaderCache: { hint: `${e.cacheKey};${E};${_};${R};${N};${F};${A};${z};${v}`, inputDependencies: B }, getRunData: () => ({ outputs: [{ dims: d ? d(r) : r, dataType: t[0].dataType }], dispatchGroup: { x: I[0], y: I[1], z: I[2] }, programUniforms: X }), getShaderSource: L };
  };
});
var Wh;
var Ad;
...
var Rd = V(() => {
  ...
  Fh = (t, e, r, n, o, i) => {
    ...
    if (r.group !== 1) {
      let A = [e[0]];
      if (o) {
        let v = t.kernelCustomData.wT ?? t.compute(Be(e[1], xo), { inputs: [1], outputs: [r.wIsConst ? -2 : -1] })[0];
        r.wIsConst && !t.kernelCustomData.wT && (t.kernelCustomData.wT = v), A.push(v);
      } else A.push(e[1]);
      e.length === 3 && A.push(e[2]), !t.adapterInfo.isArchitecture("ampere") && o && e[1].dims[0] === r.group && e[1].dims[1] === 1 && r.dilations[0] === 1 && r.dilations[1] === 1 ? t.compute(Bd(A, r, i, n), { inputs: A }) : t.compute(zd(A, r, i, n), { inputs: A });
      return;
    }
    ...
    if (_ || p === 1 && m === 1 && r.dilations[0] === 1 && r.dilations[1] === 1 && r.strides[0] === 1 && r.strides[1] === 1 && r.pads[0] === 0 && r.pads[1] === 0) {
      let A = i[0], z, v, R, N = [];
      if (o) {
        let X = t.kernelCustomData.wT ?? t.compute(Be(e[1], xo), { inputs: [1], outputs: [r.wIsConst ? -2 : -1] })[0];
        if (r.wIsConst && !t.kernelCustomData.wT && (t.kernelCustomData.wT = X), _) {
          let B = u * d * c;
          z = e[0].reshape([1, A, B]), v = X.reshape([1, B, b]), R = [1, A, b];
    ...
    let T = true, x = t.kernelCustomData.wT ?? t.compute(Be(e[1], xo), { inputs: [1], outputs: [r.wIsConst ? -2 : -1] })[0];
...
var Hd = V(() => {
  ...
  Zh = (t, e, r, n, o, i) => (t - 1) * e + r + (n - 1) * o + 1 - i, Qh = (t, e, r, n, o) => {
    ...
    let o = t.kernelCustomData.wT ?? t.compute(Be(e[1], [2, 3, 0, 1]), { inputs: [1], outputs: [r.wIsConst ? -2 : -1] })[0];
...
var ko = V(() => {
  ...
  ${m.mainStart()}
    ...
    if (s && k.size(s.dims) > 0) {
      ...
      return d = Pg(t, i, s, e, n, r * o, u), d = d.reshape([e, n, r, o]), r === 1 || n === 1 ? d : t.compute(Be(d, Tl.perm), { inputs: [d], outputs: [-1] })[0];
    } else return i.dims.length === 3 && (d = i.reshape([e, n, r, o])), r === 1 || n === 1 ? d : t.compute(Be(d, Tl.perm), { inputs: [d], outputs: [-1] })[0];
  }, Cl = (t, e) => {
...
var zo = V(() => {
  ...
  Mg = (t, e) => {
    ...
    return { name: "RotaryEmbedding", shaderCache: { hint: ee({ interleaved: r }).cacheKey, inputDependencies: ["rank", "rank", "rank", "rank"] }, getShaderSource: _, getRunData: () => ({ outputs: [{ dims: t[0].dims, dataType: t[0].dataType }], dispatchGroup: { x: Math.ceil(k.size(g) / Bt) }, programUniforms: b }) };
  }, kl = (t, e) => {
...
var zl = V(() => {
  ...
  Rg = (t, e) => {
    ...
    return e.dims.length === 3 && r.kvSequenceLength !== 0 && (n = e.reshape([r.batchSize, r.kvSequenceLength, o, r.headSize]), n = t.compute(Be(n, Ug.perm), { inputs: [n], outputs: [-1] })[0]), n;
  }, Ng = (t, e, r, n) => {
...
var Ml = V(() => {
  ...
  ${$.mainStart(g)}
    ...
    let n = e[0].dims, o = n, i = 2, s = n[0], u = n[1], d = k.sizeFromDimension(n, i), c = fe(d), p = k.size(o) / c, m = Bl(t, e[0], e[1], e[2], s, d, u, r.epsilon), g = [s, u, d / c], y = [s, u], b = ["type", "none"], _ = (T) => {
  ...
  ${T.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.output_size")}
    ...
    g = g && n[n.length - 1] !== 1;
    let b = g ? t.compute(Be(t.inputs[0], y), { inputs: [t.inputs[0]], outputs: [-1] })[0] : t.inputs[0].reshape(Array.from({ length: n.length }, (x, $) => n[y[$]])), _ = Bl(t, b, e[1], e[2], i, u, s, r.epsilon), T = (x) => {
...
`}
    ...
    return new Uint32Array(e.buffer, e.byteOffset, 1)[0];
  }, _c = (t, e) => {
    let r = [], n = [], o = [], i = Ib(t);
...
var kc = V(() => {
  ...
  zb = (t) => {
    ...
    u ? (c = Array.from({ length: i }, (z, v) => v), c[s] = i - 1, c[i - 1] = s, d = t.compute(Be(r, c), { inputs: [r], outputs: [-1] })[0]) : d = r;
...
var Vc = V(() => {
  ...
  Vb = (t, e) => {
    ...
    var _a, _b2;
    let n = t.name;
    return ((_a = t.shaderCache) == null ? void 0 : _a.hint) && (n += "[" + t.shaderCache.hint + "]"), n += ":" + r + `:${Vb(e, ((_b2 = t.shaderCache) == null ? void 0 : _b2.inputDependencies) ?? new Array(e.length).fill("dims"))}`, n;
  }, Bo = class {
    constructor(e) {
    ...
    async initialize(e, r) {
      ...
      this.adapterInfo = new Bo(u), this.gpuDataManager = Vs(this), this.programManager = new mn(this), this.kernels = /* @__PURE__ */ new Map(), this.kernelPersistentData = /* @__PURE__ */ new Map(), this.kernelCustomData = /* @__PURE__ */ new Map(), Lr(e.logLevel, !!e.debug), this.device.onuncapturederror = (d) => {
    ...
    dispose() {
      var _a;
      typeof this.querySet < "u" && this.querySet.destroy(), this.gpuDataManager.dispose(), this.device && ((_a = this.env) == null ? void 0 : _a.webgpu) && this.device.lost.then(() => {
    ...
    flush() {
      ...
      this.queryType !== "none" && (this.commandEncoder.resolveQuerySet(this.querySet, 0, this.pendingDispatchNumber * 2, this.queryResolveBuffer, 0), e = this.device.createBuffer({ size: this.pendingDispatchNumber * 2 * 8, usage: GPUBufferUsage.MAP_READ | GPUBufferUsage.COPY_DST }), this.pendingQueries.set(e, this.pendingKernels), this.pendingKernels = [], this.commandEncoder.copyBufferToBuffer(this.queryResolveBuffer, 0, e, 0, this.pendingDispatchNumber * 2 * 8)), this.device.queue.submit([this.commandEncoder.finish()]), this.gpuDataManager.refreshPendingBuffers(), this.commandEncoder = null, this.pendingDispatchNumber = 0, this.queryType !== "none" && e.mapAsync(GPUMapMode.READ).then(() => {
        ...
        for (let o = 0; o < r.length / 2; o++) {
          ...
          if ((_a = this.env.webgpu.profiling) == null ? void 0 : _a.ondata) this.env.webgpu.profiling.ondata({ version: 1, inputsMetadata: m.map((x) => ({ dims: x.dims, dataType: rt(x.dataType) })), outputsMetadata: g.map((x) => ({ dims: x.dims, dataType: rt(x.dataType) })), kernelId: s, kernelType: d, kernelName: c, programName: p, startTime: _, endTime: T });
          else {
            let x = "";
            m.forEach((S, I) => {
...
var Wc = V(() => {
  ...
  ur = class t {
    ...
    compute(e, r) {
      var _a;
      let n = ((_a = r == null ? void 0 : r.inputs) == null ? void 0 : _a.map((u) => typeof u == "number" ? this.inputs[u] : u)) ?? this.inputs, o = (r == null ? void 0 : r.outputs) ?? [], i = (u, d, c) => new ur(this.module, d, this.output(u, c), c), s = (u, d) => {
        let c = xt(u, d);
...
var Qn = V(() => {
  ...
  Gb = (t, e) => {
    ...
    var _a, _b2;
    (_b2 = (_a = ye()).asyncInit) == null ? void 0 : _b2.call(_a);
    ...
    try {
      if ([s, d] = await Ss(e), (e == null ? void 0 : e.externalData) && o.mountExternalData) {
        let I = [];
      ...
      for (let I of (e == null ? void 0 : e.executionProviders) ?? []) if ((typeof I == "string" ? I : I.name) === "webnn") {
        if (o.shouldTransferToMLTensor = false, typeof I != "string") {
          let A = I, z = A == null ? void 0 : A.context, v = A == null ? void 0 : A.gpuDevice, R = A == null ? void 0 : A.deviceType, N = A == null ? void 0 : A.powerPreference;
      ...
      i = await o._OrtCreateSession(r, n, s), (_a = o.webgpuOnCreateSession) == null ? void 0 : _a.call(o, i), i === 0 && me("Can't create a session."), (_b2 = o.jsepOnCreateSession) == null ? void 0 : _b2.call(o), o.currentContext && (o.webnnRegisterMLContext(i, o.currentContext), o.currentContext = void 0, o.shouldTransferToMLTensor = true);
      let [m, g] = Hb(i), y = !!(e == null ? void 0 : e.enableGraphCapture), b = [], _ = [], T = [], x = [], $ = [];
      for (let I = 0; I < m; I++) {
        let [E, A, z] = Gc(i, I);
      ...
      for (let I = 0; I < g; I++) {
        ...
        {
          if (y && (e == null ? void 0 : e.preferredOutputLocation) === void 0) {
            $.push("gpu-buffer");
            continue;
          }
          let R = typeof (e == null ? void 0 : e.preferredOutputLocation) == "string" ? e.preferredOutputLocation : ((_c2 = e == null ? void 0 : e.preferredOutputLocation) == null ? void 0 : _c2[v]) ?? "cpu", N = o.webnnIsGraphOutput;
          if (R === "cpu" && N && N(i, v)) {
    ...
    try {
      ...
      if (g && !b) {
        ...
        for (let Z = 0; Z < T; Z++) {
          let te = n[Z];
          ((_a = o[Z]) == null ? void 0 : _a[3]) ? (A.push(I[Z]), s._OrtBindOutput(L, m[te], I[Z], 0) !== 0 && me(`Can't bind pre-allocated output[${Z}] for session=${t}.`)) : s._OrtBindOutput(L, m[te], 0, Y[te]) !== 0 && me(`Can't bind output[${Z}] to ${Q[Z]} for session=${t}.`);
        }
        wt("wasm bindInputsOutputs"), Mt.set(t, [c, p, m, g, y, true]);
      }
      (_b2 = s.jsepOnRunStart) == null ? void 0 : _b2.call(s, c), (_c2 = s.webnnOnRunStart) == null ? void 0 : _c2.call(s, c);
      let q;
      ...
      for (let L = 0; L < T; L++) {
        ...
        try {
          ...
          ae = rt(M);
          let Pe = g == null ? void 0 : g.outputPreferredLocations[n[L]];
          if (ae === "string") {
      ...
      (_d2 = s.webnnOnRunEnd) == null ? void 0 : _d2.call(s, c), s.stackRestore(z), S.forEach((q) => s._OrtReleaseTensor(q)), I.forEach((q) => s._OrtReleaseTensor(q)), E.forEach((q) => s._free(q)), x !== 0 && s._OrtReleaseRunOptions(x), $.forEach((q) => s._free(q));
    }
  }, Dr = (t) => {
    let e = ye(), r = Mt.get(t);
  ...
  Rt = () => !!_e.wasm.proxy && typeof document < "u", dr = false, hn = false, gn = false, Uo = /* @__PURE__ */ new Map(), qt = (t, e) => {
    ...
    if (!hn) {
      ...
      if (dr = true, Rt()) return new Promise((t, e) => {
        Fe == null ? void 0 : Fe.terminate(), _s().then(([r, n]) => {
          try {
...
export {
  _f as InferenceSession,
  Tr as TRACE,
  _t as TRACE_EVENT_BEGIN,
  wt as TRACE_EVENT_END,
  Ve as TRACE_FUNC_BEGIN,
  Re as TRACE_FUNC_END,
  je as Tensor,
  oT as default,
  _e as env,
