import { Kr as Matrix3, at as Color, bs as Vector3, co as SRGBColorSpace, st as ColorManagement, ys as Vector2 } from "./three.module-DMWBM_3t.js";
//#region node_modules/.pnpm/three@0.171.0/node_modules/three/examples/jsm/exporters/OBJExporter.js
var OBJExporter = class {
	parse(object) {
		...
		function parseLine(line) {
			...
			if (type === "Line") {
				output += "l ";
				for (let j = 1, l = vertices.count; j <= l; j++) output += indexVertex + j + " ";
				output += "\n";
			}
		...
		object.traverse(function(child) {
			if (child.isMesh === true) parseMesh(child);
			if (child.isLine === true) parseLine(child);
			if (child.isPoints === true) parsePoints(child);
		});
		return output;
	}
};
