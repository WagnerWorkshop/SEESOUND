...
const FIXED_RULE_ROWS = Object.freeze([
    ...
    { target: 'spawnedParticles', section: 'Light Particles', subgroup: 'Appearance', output: 'gradientU', label: 'Color' },
    ...
    { target: 'lines', section: 'Lines', subgroup: 'Appearance', output: 'gradientU', label: 'Color' },
    ...
    // Background
    { target: 'background', section: 'Background', subgroup: 'Appearance', output: 'gradientU', label: 'Color' },
...
function createMenuPane(item) {
    ...
    const closeButton = el('button', 'cp-btn cp-btn-sm', { type: 'button', text: UI_TEXT.menu.collapse })
