...
function _coerceRuleLayer(raw, index) {
    ...
    return {
        ...
        layerShapeType,
        layerPositioning,
        layerType: (source.layerType === 'modifier') ? 'modifier' : 'generator',
        audioTrackId: (typeof source.audioTrackId === 'string' && source.audioTrackId) ? source.audioTrackId : 'full',
        curveFitting: source.curveFitting === true,
        definitions,
...
const PARAMS_BASE = [
    ...
    {
        key: 'adjustForHumanHearing', group: 'inputProcessing', label: 'Hearing Compensation',
